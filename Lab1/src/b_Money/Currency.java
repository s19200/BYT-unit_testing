...
public class Currency {
	...
	public Integer universalValue(Integer amount) {
		...
		Double withCoins = amountInDouble/100;
		Double amountInUniversal = withCoins*this.rate;
		Double a = amountInUniversal*100;
	...
	*/
	public Integer valueInThisCurrency(Integer amount, Currency othercurrency) {
		Double amountInDouble = amount.doubleValue();
		Double withCoins = amountInDouble/100;
		Double universal = withCoins/this.rate;
		Double valueInThisCurrency = universal*othercurrency.rate;
		return valueInThisCurrency.intValue()*100;
	}
}
